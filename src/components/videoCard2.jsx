...
// CSS Classes and Styling: It seems like you have some custom CSS classes like width-9-20 and width-11-20. Consider using Tailwind CSS utility classes instead of custom ones to maintain consistency and improve readability.

// Conditional Rendering of Video Title: You're rendering the video title twice based on the viewport width. Instead of duplicating the <h4> element, you can conditionally apply a class to control the title length using Tailwind CSS classes like truncate to truncate the title if it exceeds a certain length.

// Usage of max-width: Instead of hardcoding the maximum width of the video title, consider using Tailwind CSS's responsive design features like max-w-[your_value_here] to set a maximum width based on the viewport size.
  ...
  return (
    <div className="video-card flex flex-row mb-2">
      ...
      <div className="video-card--content flex flex-row width-11-20 pl-2">
        <div className="video-details">
          <Link to={"/" + video.videosId}>
            <h4 className="video-title font-medium leading-5 text-sm pb-1 truncate lg:max-w-xl">
              {video.title}
            </h4>
          </Link>
          <div>
